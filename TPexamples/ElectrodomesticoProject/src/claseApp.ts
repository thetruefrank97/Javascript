...
let listaElectrodomesticos:Electrodomestico[]=new Array(10);
...
for(let x=0;x<listaElectrodomesticos.length;x++){
    ...
    }else if(listaElectrodomesticos[x] instanceof Lavadora){
        sumaLavadoras = sumaLavadoras + listaElectrodomesticos[x].precioFinal();
    }else if(listaElectrodomesticos[x] instanceof Television){
